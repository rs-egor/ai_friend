...
const HowItWorksSection = () => {
  ...
  const steps = [
    { icon: UserPlus, num: "1", title: t("landing.how_it_works_1_title"), desc: t("landing.how_it_works_1_desc") },
    { icon: MessageSquare, num: "2", title: t("landing.how_it_works_2_title"), desc: t("landing.how_it_works_2_desc") },
    { icon: Infinity, num: "3", title: t("landing.how_it_works_3_title"), desc: t("landing.how_it_works_3_desc") },
  ];
        ...
        <div className="grid sm:grid-cols-3 gap-8">
          {steps.map(({ icon: Icon, num, title, desc }, i) => (
            <div key={i} className="text-center">
              ...
              <div className="text-primary font-display text-sm mb-2">{t("landing.how_it_works_step")} {num}</div>
